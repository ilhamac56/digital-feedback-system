...
Berisi: Konfigurasi, Database, CSS, Navigasi, dan Routing.

Kode terpisah menjadi 3 modul (Input-Process-Output):
...
# ============================================================
# Import dilakukan SETELAH semua fungsi di atas didefinisikan,
# karena input_form.py dan output_dashboard.py mengimpor dari app.py.
